...
def charger_sprites_ennemi(
    type_ennemi: str, nom_fichier: str, nb_frames: int, scale: float = 1.0
) -> list[pygame.Surface]:
    """
...
def charger_sprites_tour(
    type_tour: str, nom_fichier: str, nb_frames: int, scale: float = 1.0
) -> list[pygame.Surface]:
    """
...
def charger_animation_ui(
    dossier: str, pattern_fichier: str = "*.png", scale: float = 1.0
) -> list[pygame.Surface]:
    """
...
def charger_spritesheet_ui(
    chemin_fichier: str, nb_frames: int, scale: float = 1.0
) -> list[pygame.Surface]:
    """
...
def charger_image_simple(
    chemin_relatif: str, convert_alpha: bool = True
) -> pygame.Surface | None:
    """
...
def charger_image_assets(
    nom_fichier: str, dossier: str = "", convert_alpha: bool = True
) -> pygame.Surface | None:
    """
